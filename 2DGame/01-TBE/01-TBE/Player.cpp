...
void Player::init(const glm::ivec2 &tileMapPos, ShaderProgram &shaderProgram)
{
	...
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.f, 0.50f));
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.25f, 0.50f));
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.5f, 0.50f));
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.75f, 0.50f));
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.f, 0.75f));
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(0.25f, 0.75f));

	sprite->setAnimationSpeed(MOVE_RIGHT, 8);
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(-0.75f, 0.25f));
	/**sprite->addKeyframe(MOVE_RIGHT, glm::vec2(0.f,0.50f));
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(0.25f, 0.50f));
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(0.5f, 0.50f));
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(0.75f, 0.50f));
